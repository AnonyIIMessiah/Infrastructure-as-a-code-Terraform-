...
module "alb" {
  ...
  target_groups = [
    # App1 Target Group - TG Index = 0
    {
      ...
      targets = {
        my_app1_vm1 = {
          target_id = element([for instance in module.ec2_private_app1 : instance.id], 0)
          port      = 80
        },
        my_app1_vm2 = {
          target_id = element([for instance in module.ec2_private_app1 : instance.id], 1)
          port      = 80
        }
      }
  ...
  https_listener_rules = [
    ...
    }, # Rule-2: /app3* should go to App3 EC2 Instances    
    {
      https_listener_index = 0
      priority             = 3
      actions = [
